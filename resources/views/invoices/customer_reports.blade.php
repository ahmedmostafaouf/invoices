        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <form action="{{route('search.customer.report')}}" method="POST" role="search" autocomplete="off">
                     @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select required  name="category" id="category" class="form-control select2" onclick="console.log($(this).val())"
