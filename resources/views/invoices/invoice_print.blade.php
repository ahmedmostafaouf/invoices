								...
								<div class="card-body">
									<div class="invoice-header">
										...
										<div class="billed-from">
											<h6>البيانات</h6>
											<p>مصر المنصورة توريل <br>
											Tel No:01066273085<br>
									...
									<div class="row mg-t-20">
										<div class="col-md">
											...
											<div class="billed-to">
												<h6>{{$invoices -> category->category_name}}</h6>
												<p>El Mansoura<br>
										...
										<div class="col-md">
											...
											<p class="invoice-info-row"><span>رقم الفاتورة</span> <span>{{$invoices -> invoices_num}}</span></p>
											...
											<p class="invoice-info-row"><span>القسم:</span> <span>{{$invoices -> category->category_name}}</span></p>
										</div>
									</div>
										...
										<table class="table table-invoice border text-md-nowrap mb-0">
											<thead>
												<tr>
													...
													<th class="tx-right">مبلغ العمولى</th>
											...
											<tbody>
												<tr>
													<td>1</td>
													<td class="tx-12">{{$invoices -> category->category_name}}</td>
