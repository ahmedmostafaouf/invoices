...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الأعدادت</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الاقسام</span>
						</div>
					</div>
                        ...
                        <div class="card mg-b-20">
                            <div class="card-header pb-0">
                                <div class="d-flex justify-content-between">
                                    ...
                                    @else
                                        <a class="modal-effect btn btn-outline-primary btn-block disabled">اضافة قسم</a>
                                    @endcan
                                    ...
                                    <div class="modal-body">
                                        <form action="{{url('category/destroy')}}" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="id" id="id" value="">
                                                <input class="form-control" disabled name="category_name" id="category_name" type="text" readonly>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success">تاكيد</button>
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">اغلاق</button>
