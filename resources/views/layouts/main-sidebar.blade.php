			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{asset('assets/img/faces/avataaars.svg')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
                    ...
                    @can('الفواتير')
                    <li class="side-item side-item-category">الفواتير
                    <li class="slide">
						...
						<ul class="slide-menu">
                                ...
                                @endcan
                                @can('ارشيف الفواتير')
							       <li><a class="slide-item" href="{{ route('archive.index') }}">الأرشفة</a></li>
                                @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('تقرير الفواتير')
                                <li><a class="slide-item" href="{{ route('get.report') }}">تقرير الفواتير</a></li>
                            @endcan
                                @can('تقرير العملاء')
                                    <li><a class="slide-item" href="{{ route('get.customer.report') }}">تقرير العملاء</a></li>
                                @endcan
						</ul>
					</li>
                    @endcan
						...
						<ul class="slide-menu">
                            ...
                            @endcan
                                @can('صلاحيات المستخدمين')
                                    <li><a class="slide-item" href="{{ route('roles.index') }}">صلاحية المستخدمين</a></li>
                                @endcan
						</ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('الاقسام')
                                <li><a class="slide-item" href="{{ route('category.index') }}">الاقسام</a></li>
                            @endcan
                                @can('المنتجات')
